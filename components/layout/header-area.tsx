...
export function ShapesBackground() {
  return (
    <div className="relative top-0 left-0 right-0 bottom- -z-10">
      <div className="z-10">
        <div className="absolute -top-7 left-0 h-[50vh] w-1/2 bg-white origin-top-left transform -skew-y-12"></div>
        <div className="absolute -top-7 right-0 h-[50vh] w-1/2 bg-white origin-top-right transform skew-y-12"></div>
      </div>
    </div>
  )
}
