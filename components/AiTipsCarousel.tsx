...
export function AiTipsCarousel() {
  ...
  return (
    <div className="border-y-2 border-orange-400 bg-white m-2 p-2">
      ...
      <div className="flex items-center justify-between bg-white">
        ...
        <button 
          ...
          aria-label="Previous tip"
        >
          <ChevronLeft size={20} className="text-orange-400 m-" />
        </button>
            ...
            {tips.map((tip, index) => (
              <div key={index} className="flex-shrink-0 w-full">
                <div className="flex items-center gap-2 px-0">
                  ...
                  <blockquote className="flex flex-col border-l-4 pl-2 border-orange-400 italic text-sm text-orange-400">
                    <p className="text-md text-black font-semibold">{tip.message}</p>
                    <p className="text-xs text-gray-500">{tip.detail}</p>
                  </blockquote>
                </div>
