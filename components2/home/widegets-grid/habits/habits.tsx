// components2/home/widegets-grid/habits/habits.tsx
'use client'

import { useState, useEffect } from 'react'

import { ChevronRight, Eye, EyeOff, Zap } from 'lucide-react'
import { Widget } from '@/components2/shared/widget/widget'
...
export function HabitsPage() {
  const [cards, setCards] = useState<HabitCard[]>([
    { id: "1", title: "Example card 1", completed: true },
    { id: "2", title: "Example card 2", completed: false },
  ])
